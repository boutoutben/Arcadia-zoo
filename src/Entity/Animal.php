...
class Animal
{
    ...
    #[ORM\JoinColumn(name:'id_habitat',referencedColumnName:'id',unique:false)]
    private ?AllHabitats $Habitats = null;

    #[ORM\OneToOne(targetEntity:'Races')]
    #[ORM\JoinColumn(name:'id_race',referencedColumnName:'id', unique:false)]
    ...
    public function setHabitats(AllHabitats|null $Habitats): self
    {
    ...
    public function setRace(Races|null $race): self
    {
        $this->Race = $race;
