...
class ModifAnimauxController extends AbstractController
{
    ...
    public function create(Request $request, EntityManagerInterface $em, $id_habitat):Response
    {
        ...
        if(isset($name)&& isset($etat)&&isset($race)){
            ...
            $collection = (new MongoDB\Client("mongodb+srv://boutoutben:boutout123@cluster0.kmaplqi.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0"))->arcadia->animal;
    ...
    public function delete(Request $request, EntityManagerInterface $em)
    {
        ...
        if($animal !=  null)
        {
            ...
            (new MongoDB\Client("mongodb+srv://boutoutben:boutout123@cluster0.kmaplqi.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0"))->arcadia->animal->deleteOne(["name"=>$nameToDelete]);
            $em->remove($animal);
            $em->flush();
