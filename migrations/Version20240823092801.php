 ...
 */
final class Version20240823092801 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE animal (id INT AUTO_INCREMENT NOT NULL, id_habitat INT DEFAULT NULL, id_race INT DEFAULT NULL, id_last_rapport INT DEFAULT NULL, name VARCHAR(255) NOT NULL, etat VARCHAR(255) NOT NULL, img VARCHAR(255) NOT NULL, date DATETIME DEFAULT NULL, nourriture VARCHAR(255) DEFAULT NULL, quantitee INT DEFAULT NULL, nb_click INT NOT NULL, UNIQUE INDEX UNIQ_6AAB231FE5AA1B98 (id_habitat), UNIQUE INDEX UNIQ_6AAB231F514FA7AD (id_race), UNIQUE INDEX UNIQ_6AAB231FFB79E9A6 (id_last_rapport), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE rapport_veterinaire (id INT AUTO_INCREMENT NOT NULL, id_animal INT DEFAULT NULL, date DATETIME NOT NULL, detail VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_CE729CDE4C9C96F2 (id_animal), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE services (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, description TEXT NOT NULL, img VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, username VARCHAR(180) NOT NULL, roles JSON NOT NULL COMMENT \'(DC2Type:json)\', password VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', UNIQUE INDEX UNIQ_IDENTIFIER_USERNAME (username), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
